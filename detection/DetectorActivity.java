...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  public final static String MODULE_MAC = "98:D3:A1:FD:74:60";
    ...
    if(bta.isEnabled()){
      ...
      mHandler = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
          ...
          if(msg.what == ConnectedThread.RECEVEID_MESSAGE) {
            byte[] bytes = (byte[]) msg.obj;
            String str = new String(bytes, 0, msg.arg1);
            received.append(str);
            Log.d("RECE",received.toString());

              Log.d("PROCESSING","AGAIN");
